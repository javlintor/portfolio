...
This course provides a comprehensive introduction to Python programming, specifically designed for students in Mathematics and Statistics at the [University of Seville](https://www.us.es/). The materials are structured as interactive Jupyter notebooks that can be executed directly in [Google Colab](https://colab.research.google.com/) with a single click, eliminating the need for local setup.
...
The final section covers professional Python development practices, including project structure and building interactive dashboards with [Dash](https://dash.plotly.com/).
...
All content is open source and available on [GitHub](https://github.com/javlintor/curso-python-us). The course website is built with [Jupyter Book](https://jupyterbook.org/), providing a clean reading experience with direct links to run notebooks in Google Colab.
...
- _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow_ by Aurelien Geron
